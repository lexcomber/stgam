...
```{r appm1, echo = T, eval = T, warning = F, message = F, out.width = "100%", fig.cap = "Diagnostic plots of `m1`."}
...
Then effect size can be examined using the `effect_size` function in `stgam`: 
```{r eval = T, echo = T}
effect_size(m2)
```
