...
#'
#' @param model_table a table of competing models generated by the `gam_model_probs()` function
#' @param terms a vector of names starting with "Intercept" plus the names of the covariates used in the GAM model (these are the names of the variables in  `input_data` )
...
do_bma = function(model_table,
  ...
  if(!relative) {
    ...
    n = sum(model_table$`Pr(M)` > thresh) + 1
