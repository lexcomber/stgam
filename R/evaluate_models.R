...
#'
#' @returns a `data.frame` with indices for each predictor variable, the knots specified in each smooth (`ks`), a AIC score (`aic`) for each model and the associated formula (`f`). See Comber et al (2026) \doi{10.1080/13658816.2026.2671964}. The output should be passed to the `gam_model_rank` function.
