...
|Name            |Type     |Description                                                                                                                        |
|:---------------|:--------|:----------------------------------------------------------------------------------------------------------------------------------|
|calculate_vcs   |function |Extracts varying coefficient estimates (for SVC, TVC and STVC)                                                                     |
|do_bma          |function |Undertake undertake coefficient averaging using Bayesian Model Avergaing (BMA), weighting different models by their probabailities |
|evaluate_models |function |Creates evaluates multiple varying coefficient GAM GP smooth models (SVC or STVC)                                                  |
|gam_model_probs |function |Calculates the model probabilities of the different GAM models generated by evaluate_models'                                       |
|plot_1d_smooth  |function |Plots a 1-Dimensional GAM smooth                                                                                                   |
